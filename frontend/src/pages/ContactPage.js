...
import { Mail, Phone, MapPin, Clock, Send, MessageCircle, Headphones, ShoppingCart } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 h-fit">
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <div className="space-y-2">
                  <Link to="/faq" className="block text-primary-600 hover:text-primary-700 transition-colors">
                    📋 Frequently Asked Questions
                  </Link>
                  <Link to="/shipping" className="block text-primary-600 hover:text-primary-700 transition-colors">
                    🚚 Shipping Information
                  </Link>
                  <Link to="/returns" className="block text-primary-600 hover:text-primary-700 transition-colors">
                    🔄 Returns & Exchanges
                  </Link>
                  <Link to="/track-order" className="block text-primary-600 hover:text-primary-700 transition-colors">
                    📦 Track Your Order
                  </Link>
                </div>
              </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <a href="tel:+15551234567" className="bg-primary-600 hover:bg-primary-700 text-white px-6 py-2 rounded-lg transition-colors inline-block">
              Call Now
            </a>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <p className="text-gray-600 mb-4">Send us a detailed message anytime</p>
            <a href="mailto:support@modernshop.com" className="bg-primary-600 hover:bg-primary-700 text-white px-6 py-2 rounded-lg transition-colors inline-block">
              Send Email
            </a>
          </div>
        </div>
